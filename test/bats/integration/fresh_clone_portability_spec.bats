...
setup() {
  ...
  ln -s .base/downstream/script/docker/wrapper/build.sh "${REPO_DIR}/build.sh"
...
_seed_stale_setup_conf() {
  ...
  cp "${REPO_DIR}/.base/downstream/config/docker/setup.conf" "${REPO_DIR}/config/docker/setup.conf"
