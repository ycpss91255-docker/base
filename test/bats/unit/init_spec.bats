...
setup() {
  ...
  for _sl in log transcript env conf setup_conf conf_logging _tui_conf schema stage compose deploy compose_emit config_summary setup_cmd setup_detect hook; do
