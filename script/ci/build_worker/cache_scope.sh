...
# but different build_args (the env / ros2_distro pattern, #272); single-call
...
# the shape -- which carries a real bug history (#272 scoping; #378 the
# shared-scope manifest cascade) -- is host-testable under `just test`
