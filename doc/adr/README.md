...
are each right (ADR-00000034 records why that is kept rather than fixed).
...
- 00000032 -> invariant 6. Postdates the audit; listed for index
  completeness.
...
- **00000034** postdates the audit and is listed for index completeness;
