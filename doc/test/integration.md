...
Integration specs under `test/bats/integration/`: **160 tests**.
...
| `no file a repo can carry, scaffold output or not, can quietly become a signal (#928)` | The class, over scaffold output plus what no scaffold writes |
