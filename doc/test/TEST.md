...
Template self-tests: **3265 tests** total (3116 unit + 149 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (16) and smoke (34) tests are tracked here
> too but are **not** in the 3265 figure: System specs need host docker
...
Self-test grand total (unit + integration): **3265**.
