...
Template self-tests: **2690 tests** total (2572 unit + 118 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (9) and smoke (34) tests are tracked here
> too but are **not** in the 2690 figure: System specs need host docker
...
Self-test grand total (unit + integration): **2690**.
