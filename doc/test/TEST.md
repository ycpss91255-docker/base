...
Template self-tests: **3389 tests** total (3240 unit + 149 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (16) and smoke (34) tests are tracked here
> too but are **not** in the 3389 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 3240 |
...
Self-test grand total (unit + integration): **3389**.
