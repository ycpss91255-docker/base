...
Template self-tests: **3083 tests** total (2936 unit + 147 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (15) and smoke (34) tests are tracked here
> too but are **not** in the 3083 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 2936 |
...
Self-test grand total (unit + integration): **3083**.
