...
Template self-tests: **2935 tests** total (2794 unit + 141 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (12) and smoke (34) tests are tracked here
> too but are **not** in the 2935 figure: System specs need host docker
...
Self-test grand total (unit + integration): **2935**.
