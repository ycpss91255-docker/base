...
Template self-tests: **2700 tests** total (2579 unit + 121 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (9) and smoke (34) tests are tracked here
> too but are **not** in the 2700 figure: System specs need host docker
...
| [integration.md](integration.md) | `test/bats/integration/` -- init / upgrade / dispatch across components (Integration level) | 121 |
...
Self-test grand total (unit + integration): **2700**.
