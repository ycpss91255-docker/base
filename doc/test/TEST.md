...
Template self-tests: **3478 tests** total (3326 unit + 152 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (19) and smoke (38) tests are tracked here
> too but are **not** in the 3478 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 3326 |
...
Self-test grand total (unit + integration): **3478**.
