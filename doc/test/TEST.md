...
Template self-tests: **3243 tests** total (3094 unit + 149 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (13) and smoke (34) tests are tracked here
> too but are **not** in the 3243 figure: System specs need host docker
...
Self-test grand total (unit + integration): **3243**.
