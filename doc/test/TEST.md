...
Template self-tests: **2163 tests** total (2076 unit + 87 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (5) and smoke (38) tests are tracked here
> too but are **not** in the 2163 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 2076 |
...
Self-test grand total (unit + integration): **2163**.
