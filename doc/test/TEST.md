...
Template self-tests: **3845 tests** total (3688 unit + 157 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (19) and smoke (38) tests are tracked here
> too but are **not** in the 3845 figure: System specs need host docker
...
Self-test grand total (unit + integration): **3845**.
