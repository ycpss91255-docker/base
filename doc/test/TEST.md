...
Template self-tests: **2896 tests** total (2765 unit + 131 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (12) and smoke (34) tests are tracked here
> too but are **not** in the 2896 figure: System specs need host docker
...
| [integration.md](integration.md) | `test/bats/integration/` -- init / upgrade / dispatch across components (Integration level) | 131 |
...
Self-test grand total (unit + integration): **2896**.
