...
Template self-tests: **3148 tests** total (3001 unit + 147 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (12) and smoke (34) tests are tracked here
> too but are **not** in the 3148 figure: System specs need host docker
...
Self-test grand total (unit + integration): **3148**.
