...
Template self-tests: **3701 tests** total (3541 unit + 160 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (19) and smoke (38) tests are tracked here
> too but are **not** in the 3701 figure: System specs need host docker
...
| [integration.md](integration.md) | `test/bats/integration/` -- init / upgrade / dispatch across components (Integration level) | 160 |
...
Self-test grand total (unit + integration): **3701**.
