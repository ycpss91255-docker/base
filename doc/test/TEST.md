...
Template self-tests: **2954 tests** total (2816 unit + 138 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (12) and smoke (34) tests are tracked here
> too but are **not** in the 2954 figure: System specs need host docker
...
Self-test grand total (unit + integration): **2954**.
