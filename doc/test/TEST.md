...
Template self-tests: **3304 tests** total (3153 unit + 151 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (13) and smoke (34) tests are tracked here
> too but are **not** in the 3304 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 3153 |
...
Self-test grand total (unit + integration): **3304**.
