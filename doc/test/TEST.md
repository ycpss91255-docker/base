...
Template self-tests: **3496 tests** total (3345 unit + 151 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (16) and smoke (34) tests are tracked here
> too but are **not** in the 3496 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 3345 |
...
Self-test grand total (unit + integration): **3496**.
