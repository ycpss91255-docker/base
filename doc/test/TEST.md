...
Template self-tests: **2135 tests** total (2049 unit + 86 integration).

> "Self-test total" is the `just test` suite — what runs in the
> `Self Test` CI job. Behavioural (5) and smoke (38) tests are tracked
> here too but are **not** in the 2135 figure: behavioural specs need
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` — library, wrappers, generators, templates | 2049 |
...
Self-test grand total (unit + integration): **2135**.
