...
Template self-tests: **3094 tests** total (2947 unit + 147 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (12) and smoke (34) tests are tracked here
> too but are **not** in the 3094 figure: System specs need host docker
...
Self-test grand total (unit + integration): **3094**.
