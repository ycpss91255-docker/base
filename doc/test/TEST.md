...
Template self-tests: **3105 tests** total (2956 unit + 149 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (12) and smoke (34) tests are tracked here
> too but are **not** in the 3105 figure: System specs need host docker
...
Self-test grand total (unit + integration): **3105**.
