...
> too but are **not** in the 3093 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 2946 |
...
Self-test grand total (unit + integration): **3093**.
