...
Template self-tests: **2187 tests** total (2093 unit + 94 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (5) and smoke (40) tests are tracked here
> too but are **not** in the 2187 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 2093 |
...
Self-test grand total (unit + integration): **2187**.
