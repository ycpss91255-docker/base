...
Template self-tests: **2393 tests** total (2277 unit + 116 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (5) and smoke (40) tests are tracked here
> too but are **not** in the 2393 figure: System specs need host docker
...
Self-test grand total (unit + integration): **2393**.
