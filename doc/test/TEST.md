...
Template self-tests: **3269 tests** total (3117 unit + 152 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (13) and smoke (34) tests are tracked here
> too but are **not** in the 3269 figure: System specs need host docker
...
Self-test grand total (unit + integration): **3269**.
