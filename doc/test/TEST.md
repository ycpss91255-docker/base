...
Template self-tests: **2595 tests** total (2477 unit + 118 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (9) and smoke (40) tests are tracked here
> too but are **not** in the 2595 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 2477 |
...
Self-test grand total (unit + integration): **2595**.
