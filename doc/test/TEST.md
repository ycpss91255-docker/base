...
Template self-tests: **4304 tests** total (4139 unit + 165 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (19) and smoke (39) tests are tracked here
> too but are **not** in the 4304 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 4139 |
...
Self-test grand total (unit + integration): **4304**.
