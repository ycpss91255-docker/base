...
Template self-tests: **2783 tests** total (2658 unit + 125 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (9) and smoke (34) tests are tracked here
> too but are **not** in the 2783 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 2658 |
...
Self-test grand total (unit + integration): **2783**.
