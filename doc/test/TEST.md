...
Template self-tests: **4335 tests** total (4167 unit + 168 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (19) and smoke (39) tests are tracked here
> too but are **not** in the 4335 figure: System specs need host docker
...
Self-test grand total (unit + integration): **4335**.
