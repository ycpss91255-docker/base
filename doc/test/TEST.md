...
Template self-tests: **3654 tests** total (3499 unit + 155 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (19) and smoke (38) tests are tracked here
> too but are **not** in the 3654 figure: System specs need host docker
...
Self-test grand total (unit + integration): **3654**.
