...
Template self-tests: **2359 tests** total (2248 unit + 111 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (5) and smoke (40) tests are tracked here
> too but are **not** in the 2359 figure: System specs need host docker
...
Self-test grand total (unit + integration): **2359**.
