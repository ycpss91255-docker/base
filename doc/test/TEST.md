...
Template self-tests: **2165 tests** total (2078 unit + 87 integration).

> "Self-test total" is the `just test` suite -- what runs in the
> `Self Test` CI job. System (5) and smoke (38) tests are tracked here
> too but are **not** in the 2165 figure: System specs need host docker
...
| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `test/bats/unit/` -- library, wrappers, generators, templates (Unit level) | 2078 |
...
Self-test grand total (unit + integration): **2165**.
